    ...
    <div class="uslugi-wrapper">
      ...
      >
        ...
        <tr>
          ...
          <td>
            <p class="material-text">
              имеет уникальные физические характеристики, так как сочетает в себе преимущества пластика
              и резины.
              <br />
              ТРЕ можно сравнить с вулканизированной резиной: он прочен, но в то же время устойчив к
              деформации. В отличие от резины, ТРЕ используется в аддитивном производстве для
        ...
        <tr>
          ...
          <td>
            <p class="material-text">
              ...
              получаются более хрупкими, чем из полиамида. Однако он служит для создания форм и изделий
              с максимально качественной поверхностью. Используются для изготовления мастер-моделей для
        ...
        <tr>
          ...
          <td>
            <p class="material-text">
              Высокая химическая стойкость. Низкий коэффициент трения. Возможность печати как мелких,
              так и крупных изделий.
            </p>
          </td>
        </tr>
      </UslugiTable>
