...
defineOptions({ name: 'CalculateMillingPage2' })
...
onMounted(async () => {
  try {
    await Promise.all([loadMaterials(), loadFinishAndTolerance(), ensureLocalStpCacheReady()])
      ...
      <el-row :gutter="0" class="calc-page__row">
        <el-col :offset="3" :span="18" :xs="{ span: 24, offset: 0 }">
          <div class="calc-page__card">
            <h2 class="calc-page__title">Механическая обработка</h2>
